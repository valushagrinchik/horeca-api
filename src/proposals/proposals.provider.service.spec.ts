...
describe('ProposalsProviderService', () => {
    let service: ProposalsProviderService
    ...
    beforeAll(async () => {
        const module = await Test.createTestingModule({
            providers: [ProposalsProviderService, PrismaService],
        }).compile()

        service = module.get<ProposalsProviderService>(ProposalsProviderService)
    ...
    describe('findAppropriateProposals', () => {
        it('should return all appropriate horeca proposals for provider', async () => {
            const response = await service.findAppropriateProposals({ id: providerUser.id })
